...
const authSchema = z
  .object({
    ...
    .max(20, { message: "El nombre de usuario debe tener un MAXIMO de 20 caracteres" }),
    fullname: z.string({
      required_error: "El nombre es requerido",
    }).min(5, { message: "El nombre y apellido debe tener un MÍNIMO de 5 caracteres" })
    .max(20, { message: "El nombre  y apellido debe tener un MAXIMO de 20 caracteres" }),
    password: z.string({
      required_error: "La contraseña es requerida",
    }).min(8, { message: "La contraseña debe tener un MÍNIMO de 8 caracteres" })
    .max(20, { message: "La contraseña debe tener un MAXIMO de 20 caracteres" })
    ...
    birthdate: z.string({required_error: "La fecha de nacimiento es requerida"}).date(),
